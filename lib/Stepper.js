...
function Stepper(_ref) {
  var activeStep = _ref.activeStep,
      ...
      activeCircleFontColor = _ref.activeCircleFontColor,
      completeCircleFontColor = _ref.completeCircleFontColor,
      activeTitleColor = _ref.activeTitleColor,
      completeTitleColor = _ref.completeTitleColor,
      defaultTitleColor = _ref.defaultTitleColor,
      size = _ref.size,
      activeCircleSize = _ref.activeCircleSize,
      circleFontSize = _ref.circleFontSize,
      activeCircleFontSize = _ref.activeCircleFontSize,
      ...
      defaultBarThickness = _ref.defaultBarThickness,
      completeBarThickness = _ref.completeBarThickness;

  var activeCompleted = completedSteps.includes(activeStep.toString());
...
Stepper.propTypes = {
  ...
  activeCompleted: _propTypes.PropTypes.bool,
